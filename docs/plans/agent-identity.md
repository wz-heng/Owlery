...
一件事:**avatar/emoji 机制是「彻底退役」还是「保留为印文覆盖」**。
本文推荐彻底退役(理由在 §3),但现存 agent 若有人为设置的 emoji
头像,退役即丢弃该设置。若用户舍不得,退路是允许单字符覆盖印文
(仍压进蜡、仍单色),emoji 则明确不支持。
